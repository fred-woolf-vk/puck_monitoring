...
wget https://raw.githubusercontent.com/fred-woolf-vk/gw6200_scripts/master/collect_db_stats_prometheus.py
wget https://raw.githubusercontent.com/fred-woolf-vk/gw6200_scripts/master/get_modem_status.py
